...
Tagging a release on this repository will update the:
  ...
  - [Python SDK](https://github.com/fern-vocode/vocode-python)
  - [TypeScript SDK](https://github.com/fern-vocode/vocode-node)

## What is in this repository?

This repository contains

- Vocode's OpenAPI spec which lives in the [openapi](./fern/api/openapi/) folder
